...
const float start_axis_degAngle[no_of_steppers] = {183.82, 122.19, 2.33, 107.69, 9.67, 356.60}; //Angle in degrees, encoder values when in kinematic zeroed position - 19-Apr-25
