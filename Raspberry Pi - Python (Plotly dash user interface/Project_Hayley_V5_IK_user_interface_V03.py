...
# writeAngles(values) V02 - I2C purely angles, without stepper mode, Compaitible with "Project_Hayley_ESP32_V12.ino"  
# writeAngles(values) V03 - add stepper mode
# def writeAngles(values): #V02
    ...
    html.Div([   
        ...
        html.Div([
                ...
                dcc.RadioItems(
                    ...
                    options=[{'label': i, 'value': i} for i in ['Angles', 'Steppers', 'Motor Modes', 'Path Plan']],
...
def display_page(value):
    ...
    if (value == "Angles") or (value == "Steppers"):
        ...
        div_layout = html.Div([
            ...
            dcc.Interval(
                id="interval-1s",
                interval=30000,   # milliseconds (1 second)
                n_intervals=0
            ),
...
# auto-update encoder readings every 5 sec 
@app.callback(
