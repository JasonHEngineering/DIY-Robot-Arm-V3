...
const float start_axis_degAngle[no_of_steppers] = {-173.75, 121.91, 92.53, -106.88, 10.89, -4.71}; //Angle in degrees, encoder values when in kinematic zeroed horizontal position - 2-Feb-26 - by using 3 mm pins
